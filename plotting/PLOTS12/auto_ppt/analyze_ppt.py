...
BASE_LOC='/home/abhishek/PhD/Work/work_A/photons/PCM4ALICE3/plotting/PLOTS12';
PbPb_MassResolution_Pi0_Barrel_loc= BASE_LOC+'/meson_MassResolution/PbPb/meson_MassResolution_Pi0_Barrel.png'
PbPb_MassResolution_Pi0_Forward_loc= BASE_LOC+'/meson_MassResolution/PbPb/meson_MassResolution_Pi0_Forward.png'
PbPb_MassResolution_Eta_Barrel_loc= BASE_LOC+'/meson_MassResolution/PbPb/meson_MassResolution_Eta_Barrel.png'
PbPb_MassResolution_Eta_Forward_loc= BASE_LOC+'/meson_MassResolution/PbPb/meson_MassResolution_Eta_Forward.png'

pp_MassResolution_Pi0_Barrel_loc= BASE_LOC+'/meson_MassResolution/pp/meson_MassResolution_Pi0_Barrel.png'
pp_MassResolution_Pi0_Forward_loc= BASE_LOC+'/meson_MassResolution/pp/meson_MassResolution_Pi0_Forward.png'
pp_MassResolution_Eta_Barrel_loc= BASE_LOC+'/meson_MassResolution/pp/meson_MassResolution_Eta_Barrel.png'
pp_MassResolution_Eta_Forward_loc= BASE_LOC+'/meson_MassResolution/pp/meson_MassResolution_Eta_Forward.png'



PbPb_Acceptance_meson_loc= BASE_LOC+'/meson_Acceptance/PbPb/Acceptance_meson_ALL.png'
PbPb_meson_Effeciency_loc= BASE_LOC+'/meson_Effeciency/PbPb/meson_Effeciency.png'
pp_Acceptance_meson_loc= BASE_LOC+'/meson_Acceptance/pp/Acceptance_meson_ALL.png'
pp_meson_Effeciency_loc= BASE_LOC+'/meson_Effeciency/pp/meson_Effeciency.png'

PbPb_NetEffeciency_loc= BASE_LOC+'/meson_NetEffeciency/PbPb/meson_NetEffeciency.png'
PbPb_dNdyPythia_loc= BASE_LOC+'/meson_dNdyPythia/PbPb/meson_dNdyPythia.png'
pp_NetEffeciency_loc= BASE_LOC+'/meson_NetEffeciency/pp/meson_NetEffeciency.png'
pp_dNdyPythia_loc= BASE_LOC+'/meson_dNdyPythia/pp/meson_dNdyPythia.png'

PbPb_openingangle_Pi0_loc= BASE_LOC+'/meson_openingangle/PbPb/meson_openingangle_Pi0.png'
PbPb_openingangle_Eta_loc= BASE_LOC+'/meson_openingangle/PbPb/meson_openingangle_Eta.png'
pp_openingangle_Pi0_loc= BASE_LOC+'/meson_openingangle/pp/meson_openingangle_Pi0.png'
pp_openingangle_Eta_loc= BASE_LOC+'/meson_openingangle/pp/meson_openingangle_Eta.png'

PbPb_meson_signalandbackground_Pi0B_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Pi0_B/meson_signalandbackground.png'
PbPb_meson_signalandbackground_EtaB_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Eta_B/meson_signalandbackground.png'
PbPb_meson_signalandbackground_Pi0F_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Pi0_F/meson_signalandbackground.png'
PbPb_meson_signalandbackground_EtaF_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Eta_F/meson_signalandbackground.png'

PbPb_MesonSubtractedPureGaussianFit_Pi0B_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Pi0_B/MesonSubtractedPureGaussianFit.png'
PbPb_MesonSubtractedPureGaussianFit_EtaB_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Eta_B/MesonSubtractedPureGaussianFit.png'
PbPb_MesonSubtractedPureGaussianFit_Pi0F_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Pi0_F/MesonSubtractedPureGaussianFit.png'
PbPb_MesonSubtractedPureGaussianFit_EtaF_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Eta_F/MesonSubtractedPureGaussianFit.png'

pp_meson_signalandbackground_Pi0B_loc= BASE_LOC+'/meson_ptbins_fit/pp/Pi0_B/meson_signalandbackground.png'
pp_meson_signalandbackground_EtaB_loc= BASE_LOC+'/meson_ptbins_fit/pp/Eta_B/meson_signalandbackground.png'
pp_meson_signalandbackground_Pi0F_loc= BASE_LOC+'/meson_ptbins_fit/pp/Pi0_F/meson_signalandbackground.png'
pp_meson_signalandbackground_EtaF_loc= BASE_LOC+'/meson_ptbins_fit/pp/Eta_F/meson_signalandbackground.png'

pp_MesonSubtractedPureGaussianFit_Pi0B_loc= BASE_LOC+'/meson_ptbins_fit/pp/Pi0_B/MesonSubtractedPureGaussianFit.png'
pp_MesonSubtractedPureGaussianFit_EtaB_loc= BASE_LOC+'/meson_ptbins_fit/pp/Eta_B/MesonSubtractedPureGaussianFit.png'
pp_MesonSubtractedPureGaussianFit_Pi0F_loc= BASE_LOC+'/meson_ptbins_fit/pp/Pi0_F/MesonSubtractedPureGaussianFit.png'
pp_MesonSubtractedPureGaussianFit_EtaF_loc= BASE_LOC+'/meson_ptbins_fit/pp/Eta_F/MesonSubtractedPureGaussianFit.png'

PbPb_FIT_mu_Pi0B_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Pi0_B/meson_FIT_mu.png'
PbPb_FIT_mu_Pi0F_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Pi0_F/meson_FIT_mu.png'
PbPb_FIT_mu_EtaB_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Eta_B/meson_FIT_mu.png'
PbPb_FIT_mu_EtaF_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Eta_F/meson_FIT_mu.png'

pp_FIT_mu_Pi0B_loc= BASE_LOC+'/meson_ptbins_fit/pp/Pi0_B/meson_FIT_mu.png'
pp_FIT_mu_Pi0F_loc= BASE_LOC+'/meson_ptbins_fit/pp/Pi0_F/meson_FIT_mu.png'
pp_FIT_mu_EtaB_loc= BASE_LOC+'/meson_ptbins_fit/pp/Eta_B/meson_FIT_mu.png'
pp_FIT_mu_EtaF_loc= BASE_LOC+'/meson_ptbins_fit/pp/Eta_F/meson_FIT_mu.png'

PbPb_FIT_sigma_Pi0B_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Pi0_B/meson_FIT_sigma.png'
PbPb_FIT_sigma_Pi0F_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Pi0_F/meson_FIT_sigma.png'
PbPb_FIT_sigma_EtaB_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Eta_B/meson_FIT_sigma.png'
PbPb_FIT_sigma_EtaF_loc= BASE_LOC+'/meson_ptbins_fit/PbPb/Eta_F/meson_FIT_sigma.png'

pp_FIT_sigma_Pi0B_loc= BASE_LOC+'/meson_ptbins_fit/pp/Pi0_B/meson_FIT_sigma.png'
pp_FIT_sigma_Pi0F_loc= BASE_LOC+'/meson_ptbins_fit/pp/Pi0_F/meson_FIT_sigma.png'
pp_FIT_sigma_EtaB_loc= BASE_LOC+'/meson_ptbins_fit/pp/Eta_B/meson_FIT_sigma.png'
pp_FIT_sigma_EtaF_loc= BASE_LOC+'/meson_ptbins_fit/pp/Eta_F/meson_FIT_sigma.png'

PbPb_background_loc= BASE_LOC+'/meson_signal_AND_background/PbPb/meson_background.png'
PbPb_signal_loc= BASE_LOC+'/meson_signal_AND_background/PbPb/meson_signal.png'

pp_background_loc= BASE_LOC+'/meson_signal_AND_background/pp/meson_background.png'
pp_signal_loc= BASE_LOC+'/meson_signal_AND_background/pp/meson_signal.png'

PbPb_signalVSbackground_loc= BASE_LOC+'/meson_signal_VS_background/PbPb/meson_signalVSbackground.png'
PbPb_significance_ALL_loc= BASE_LOC+'/meson_significance/PbPb/meson_significance_ALL.png'

pp_signalVSbackground_loc= BASE_LOC+'/meson_signal_VS_background/pp/meson_signalVSbackground.png'
pp_significance_ALL_loc= BASE_LOC+'/meson_significance/pp/meson_significance_ALL.png'
...
txBox10 = slide.shapes.add_textbox(left+Inches(4.5), 0, width=Inches(7), height=Inches(6.5))
tf = txBox10.text_frame
p10 = tf.add_paragraph()
p10.font.name = "Liberation Serif"
p10.font.size = Pt(32)
p10.font.bold = True
p10.text = "PbPb Results: Mass resolution pi0 and eta"

PbPb_MassResolution_Pi0_Barrel_loc = slide.shapes.add_picture(PbPb_MassResolution_Pi0_Barrel_loc, Inches(3.5), Inches(1.5),width=Inches(4.5), height=Inches(3.5))
PbPb_MassResolution_Pi0_Forward_loc = slide.shapes.add_picture(PbPb_MassResolution_Pi0_Forward_loc, Inches(8.5), Inches(1.5),width=Inches(4.5), height=Inches(3.5))
PbPb_MassResolution_Eta_Barrel_loc = slide.shapes.add_picture(PbPb_MassResolution_Eta_Barrel_loc, Inches(3.5), Inches(5.0),width=Inches(4.5), height=Inches(3.5))
PbPb_MassResolution_Eta_Forward_loc = slide.shapes.add_picture(PbPb_MassResolution_Eta_Forward_loc, Inches(8.5), Inches(5.0),width=Inches(4.5), height=Inches(3.5))
...
p10.font.size = Pt(32)
p10.font.bold = True
p10.text= "PbPb Results: Signal Fit Pi0 B"
...
p10.font.size = Pt(32)
p10.font.bold = True
p10.text= "PbPb Results: Signal Fit Pi0 F"
...
p10.font.size = Pt(32)
p10.font.bold = True
p10.text= "PbPb Results: Signal Fit Eta B"
...
p10.font.size = Pt(32)
p10.font.bold = True
p10.text= "PbPb Results: Signal Fit Eta F"
...
p10.font.size = Pt(32)
p10.font.bold = True
p10.text= "PbPb Results Pi0 B: Signal and Background comparison"
...
p10.font.size = Pt(32)
p10.font.bold = True
p10.text= "PbPb Results Pi0 F: Signal and Background comparison"
...
p10.font.size = Pt(32)
p10.font.bold = True
p10.text= "PbPb Results Eta B: Signal and Background comparison"
...
p10.font.size = Pt(32)
p10.font.bold = True
p10.text= "PbPb Results Eta F: Signal and Background comparison"
