...
//DrawGammaCanvasSettings( c_sys_uncertainity_estimate_DoubleRatio,0.1, 0.05, 0.1, 0.1);
...
DrawGammaSetMarker(hist_DoubleRatio_run2,marker_B,1.0, kRed-3 , kRed-3);
DrawGammaSetMarker(hist_DoubleRatio_ALICE3,marker_F,0.5, kBlue+3 , kBlue+3);
DrawGammaSetMarker(hist_DoubleRatio_Theory,marker_F,0.5, kRed , kRed);
//hist_DoubleRatio_run2->SetLineWidth(4);

auto l_sys_uncertainity_estimate_meson_DoubleRatio = new TLegend(0.55, 0.65, 0.85, 0.9);
...
l_sys_uncertainity_estimate_meson_DoubleRatio->AddEntry(hist_DoubleRatio_Theory,Form("ALICE 3 + Theory"),"p");
...
hist_DoubleRatio_run2->Draw("E1, C");
hist_DoubleRatio_Theory->SetFillColor(kRed-9);
hist_DoubleRatio_Theory->SetLineColor(kRed-9);
hist_DoubleRatio_Theory->Draw("E2, SAME");
hist_DoubleRatio_ALICE3->SetFillColor(kBlue-9);
hist_DoubleRatio_ALICE3->SetLineColor(kBlue);
hist_DoubleRatio_ALICE3->Draw("E2, SAME");
hist_DoubleRatio_run2->Draw("E1,C, SAME");
...
txt->SetNDC();
txt->SetTextAlign(22); // center align
txt->SetTextSize(0.03);
txt->DrawLatex(0.2, 0.05, "Theory:: arXiv_2106.11216");
...
TCanvas* c_sys_uncertainity_estimate_DoubleRatio_THeory = new TCanvas("c_sys_uncertainity_estimate_DoubleRatio_THeory","c_sys_uncertainity_estimate_DoubleRatio_THeory",0,0,600,600);  // gives the page size
//DrawGammaCanvasSettings( c_sys_uncertainity_estimate_DoubleRatio_THeory, 0.1, 0.05, 0.1, 0.1);
...
double_t Total_gamma_yield_0_5_reduced[97];
for( Int_t i = 2; i < 99 ; i++){
   Total_gamma_yield_0_5_reduced[i-2]=Total_gamma_yield_0_5[i];
}
...
TH1F* hist_Total_gamma_yield_Theory_0_5 = new TH1F("hist_Total_gamma_yield_Theory_0_5","hist_Total_gamma_yield_Theory_0_5",nbinspt_proj_rebin,pt_bin_proj_rebin);
...
for( Int_t i = 0; i < 97 ; i++){
   ...
   hist_Total_gamma_yield_Theory_0_5->SetBinContent(bin_number,Total_gamma_yield_0_5_reduced[i] ); 
...
TH1F* Decay_gamma_yield_cocktail_rebin     = (TH1F*) Decay_gamma_yield_cocktail->Rebin(nbinspt_proj_rebin,"Decay_gamma_yield_cocktail_rebin",&pt_bin_proj_rebin[0]);
//TH1F* hist_InclusivePhoton_Yield_run2_rebin     = (TH1F*) hist_InclusivePhoton_Yield_run2->Rebin(nbinspt_proj_rebin,"hist_InclusivePhoton_Yield_run2_rebin",&pt_bin_proj_rebin[0]);
TH1F* hist_Total_gamma_InclusiveYield_Theory_0_5  = (TH1F*) hist_Total_gamma_yield_Theory_0_5->Clone("hist_Total_gamma_InclusiveYield_Theory_0_5");
//hist_Total_gamma_InclusiveYield_Theory_0_5->Scale(Ncol_PbPb);
TH1F* hist_DoubleRatio_Cocktail_Theory_0_5 = new TH1F("hist_DoubleRatio_Cocktail_Theory_0_5","hist_DoubleRatio_Cocktail_Theory_0_5",nbinspt_proj_rebin,pt_bin_proj_rebin);
hist_DoubleRatio_Cocktail_Theory_0_5->Add(hist_Total_gamma_InclusiveYield_Theory_0_5,Decay_gamma_yield_cocktail_rebin);
hist_DoubleRatio_Cocktail_Theory_0_5->Divide(hist_DoubleRatio_Cocktail_Theory_0_5, Decay_gamma_yield_cocktail_rebin, 1,1,"B");
...
SetStyleHistoTH1ForGraphs(hist_DoubleRatio_Theory_0_5, p_T.Data() , "Double ratio",TextSize_lable, TextSize_title, TextSize_lable,TextSize_title, LabelOffsetX, LabelOffsetY);
...
DrawGammaSetMarker(hist_DoubleRatio_Cocktail_Theory_0_5,marker_F,0.9, kYellow+3 , kYellow+3);
//hist_DoubleRatio_Theory->SetLineWidth(4);
...
l_sys_uncertainity_estimate_meson_DoubleRatio_Centrality->AddEntry(hist_DoubleRatio_Cocktail_Theory_0_5," with cocktail","p");
...
hist_DoubleRatio_Theory_0_5->SetFillColor(kOrange-9);
hist_DoubleRatio_Theory_0_5->SetLineColor(kOrange);
hist_DoubleRatio_Theory_0_5->Draw("E1,E2 ");
hist_DoubleRatio_Theory_0_5->SetFillColor(kRed-9);
hist_DoubleRatio_Theory_0_5->SetLineColor(kRed-9);
hist_DoubleRatio_Theory->Draw("E2 SAME");
hist_DoubleRatio_Theory_5_10->Draw("E1, SAME");
hist_DoubleRatio_Theory_10_20->Draw("E1, SAME");
hist_DoubleRatio_Cocktail_Theory_0_5->Draw("E1, SAME");
