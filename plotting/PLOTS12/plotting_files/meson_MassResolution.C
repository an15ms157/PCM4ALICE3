...
switch(collisionSystem){
    ...
    ltb_Eta_B = new TLatex(0.2,0.7,"#splitline{ALICE 3 Study}{pp #sqrt{#it{s}_{NN}} = 14 TeV}");
    ltb_Pi0_F = new TLatex(0.2,0.7,"#splitline{ALICE 3 Study}{pp #sqrt{#it{s}_{NN}} = 14 TeV}");
    ltb_Pi0_B = new TLatex(0.2,0.7,"#splitline{ALICE 3 Study}{pp #sqrt{#it{s}_{NN}} = 14 TeV}");
    ltb_Eta_F = new TLatex(0.2,0.7,"#splitline{ALICE 3 Study}{pp #sqrt{#it{s}_{NN}} = 14 TeV}");
...
TCanvas* c_meson_MassResolution_Pi0_B = new TCanvas((Form("meson_MassResolution_%s_%s",LightMeson[0][0].Data(),(RapidityBlock[0][0]).Data()), Form("meson_MassResolution_%s_%s",LightMeson[0][0].Data(),(RapidityBlock[0][0]).Data()), 600, 800));
DrawGammaCanvasSettings(c_meson_MassResolution_Pi0_B, 0.1, 0.05, 0.1, 0.1);
...
TCanvas* c_meson_MassResolution_Pi0_F = new TCanvas((Form("meson_MassResolution_%s_%s",LightMeson[0][0].Data(),(RapidityBlock[1][0]).Data()), Form("meson_MassResolution_%s_%s",LightMeson[0][0].Data(),(RapidityBlock[1][0]).Data()), 600, 800));
DrawGammaCanvasSettings( c_meson_MassResolution_Pi0_F, 0.1, 0.05, 0.1, 0.1);
...
TCanvas* c_meson_MassResolution_Eta_B = new TCanvas((Form("meson_MassResolution_%s_%s",LightMeson[1][0].Data(),(RapidityBlock[0][0]).Data()), Form("meson_MassResolution_%s_%s",LightMeson[1][0].Data(),(RapidityBlock[0][0]).Data()), 600, 800));
DrawGammaCanvasSettings( c_meson_MassResolution_Eta_B, 0.1, 0.05, 0.1, 0.1);
...
TCanvas* c_meson_MassResolution_Eta_F = new TCanvas((Form("meson_MassResolution_%s_%s",LightMeson[1][0].Data(),(RapidityBlock[1][0]).Data()), Form("meson_MassResolution_%s_%s",LightMeson[1][0].Data(),(RapidityBlock[1][0]).Data()), 600, 800));
DrawGammaCanvasSettings( c_meson_MassResolution_Eta_F, 0.1, 0.05, 0.1, 0.1);
