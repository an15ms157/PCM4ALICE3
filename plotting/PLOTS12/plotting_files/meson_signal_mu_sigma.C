...
TString input_file_loc="/home/abhishek/PhD/Work/work_A/photons/PCM4ALICE3/plotting/plotting_files/ALICE3_info.root";
gSystem->Exec("mkdir ./meson_signal_mu_sigma");
gSystem->cd("./meson_signal_mu_sigma");
