...
Double_t TextSize_title=0.02;
Double_t TextSize_latex=20;
Double_t LabelOffsetLog=-0.03;
Double_t LabelOffsetX=2.0;
Double_t LabelOffsetY=2.0;
...
// Labelling //
SetStyleHistoTH1ForGraphs(histPt_ALL_rap_F_mid1_to_mid2_Pi0_Rebin, "p_{T} (GeV/c)", "1/(Bin_width*N_{ev})#frac{dN}{dy}", TextSize_lable, TextSize_title, TextSize_lable,TextSize_title,LabelOffsetY,LabelOffsetX);
