...
switch(collisionSystem){
    ...
    fileRec = new TFile("/home/abhishek/PhD/Work/work_A/photons/PCM4ALICE3/plots/plotting_files/ALICE3_significance_input.root");
    lt_meson_significance_F_b = new TLatex(0.15,0.8,"#splitline{ALICE 3 Study}{minimum bias Pb-Pb}");
    lt_meson_significance_B_b = new TLatex(0.15,0.8,"#splitline{ALICE 3 Study}{minimum bias Pb-Pb}");
...
SetStyleHistoTH1ForGraphs(hist_BackgroundPerEvent_Pi0_F, "p_{T} (GeV/c)", "Signal Yield", TextSize_lable, TextSize_title, TextSize_lable,TextSize_title, LabelOffsetX, LabelOffsetY);
